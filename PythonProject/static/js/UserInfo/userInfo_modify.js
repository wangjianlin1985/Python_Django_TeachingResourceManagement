	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			...
			if (userInfo) { 
				...
				$("#userInfo_className_modify").val(userInfo.className);
				$("#userInfo_className_modify").validatebox({
					required : true,
				...
				$("#userInfo_userState_modify").val(userInfo.userState);
				$("#userInfo_userState_modify").validatebox({
					required : true,
